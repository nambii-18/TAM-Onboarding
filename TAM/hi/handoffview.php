...
<html lang='en'>
  ...
  <g class='logo__type'>
    ...
    <path transform='translate(144.9274,727.8212)' d='M-286.3-357.7c-5.2,0-9.1,4.1-9.1,9.1c0,5.1,3.9,9.1,9.1,9.1s9.1-4.1,9.1-9.1S-281.1-357.7-286.3-357.7 M-267.9-348.5 c0,9.9-7.7,18-18.4,18s-18.4-8.1-18.4-18s7.7-18,18.4-18S-267.9-358.4-267.9-348.5'/>
                ...
                <div class='row'>
                <div class='four columns'>
                    <h4 style='display:inline-block;font-weight:bolder;'>View Dispatched Cases</h4>
                    </div>
                ...
                <!-- div style='display: inline-block; margin-top: 10px; margin-right: 40px;'>
                    ...
                    <input type='checkbox' name='sd' value='D' style='margin-top: 5px;'/><span style='padding:0 20px 0 7px;'>Shift D</span>
                            ...
                            <div style='width: 20%;position:relative;display:inline-block;float:right;'>
                                <input id='chepura' name='s1' style='width: 210px;display:inline-block;float:right;margin-left:15px;padding: 8px;border:0; border-bottom: 1px solid #1EAEDB;margin-top:1px;' type='text' placeholder='Filter By Engineer CEC'/>
                                <button class='' type='submit' name='sub' value='&#x2794;' style='position:absolute;right:10px;padding:0;border:0;font-size:medium;bottom:4px;'>&#x2794;</button>
                            </div>
                    ...
                    <table id='maintable' class='u-full-width'>
                        <thead>
                            <tr>
                                <th>PKID</th>
                                <th>Case #/Email Subject/Reason for Handoff</th>
                                <th>Customer</th>
                                <th>Case Type</th>
                                <th>First Owner</th>
                                <th>Second Owner</th>
                                <th style='white-space:nowrap;'>Time of Submit</th>
                                <th style='white-space:nowrap;'>Dispatch Time</th>
                                  </tr>
                       </thead>
						";
//                        $e='';$q='';
...
//                                    {
//						$sql="SELECT * FROM CASES  where (SHIFT like '".$shifta."' or SHIFT like '".$shiftb."' or SHIFT like '".$shiftc."' or SHIFT like '".$shiftd."') and (ENG_CEC like '".$e."'"." and QM_CEC like '".$q."') ORDER BY DT_SUBMIT DESC;";
//                        //echo $sql;
//                            }
//                            else
//                            {
//                               $sql="SELECT * FROM CASES  where  ENG_CEC like '".$e."'"." and QM_CEC like '".$q."' ORDER BY DT_SUBMIT DESC;";
//                            }
                       ...
                       // var_dump($num);
						...
						while ($row=mysqli_fetch_assoc($result)){
                            ...
                            $date_dis=$row["DT_DISPATCH"];
                            $towner=$row["TOWNER"];
                            $assign=$row["ASSIGNED"];
                            $type=$row["TYPE"];

                                if($assign==0){
                                    $towner="Not yet Assigned";
                                }
