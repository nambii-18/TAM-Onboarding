...
(function($) {
    ...
    $.fn.paginate = function(options) {
        ...
        var initTableFooter = function(table) {
            ...
            tableFoot.append("<tr><th colspan='" + nbColumns + "'></th></tr>");
            var pagination = tableFoot.find("tr th");
            ...
            if ( settings.previousButtonContent )
                pagination.append("<" + settings.paginationButtonsTagName + " class='pagination previous " + settings.paginationButtonsClass + "' id='" + settings.previousButtonId + "'>" + settings.previousButtonContent + "</" + settings.paginationButtonsTagName + ">");

            for ( var i = 0 ; i < settings.nbPages ; i++ ) {
                pagination.append("<" + settings.paginationButtonsTagName + " class='pagination " + settings.paginationButtonsClass + "'> " + (i+1) + " </" + settings.paginationButtonsTagName + ">");
            }

            if ( settings.nextButtonContent )
                pagination.append("<" + settings.paginationButtonsTagName + " class='pagination next " + settings.paginationButtonsClass + "' id='" + settings.nextButtonId + "'>" + settings.nextButtonContent + "</" + settings.paginationButtonsTagName + ">");
