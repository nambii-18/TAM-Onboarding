...
<html lang='en'>
    ...
    <head>
        ...
        <meta charset='utf-8'>
        <title>Reporting - TAM Tool &middot; Cisco CMS</title>
  ...
  <g class='logo__type'>
    ...
    <path transform='translate(144.9274,727.8212)' d='M-286.3-357.7c-5.2,0-9.1,4.1-9.1,9.1c0,5.1,3.9,9.1,9.1,9.1s9.1-4.1,9.1-9.1S-281.1-357.7-286.3-357.7 M-267.9-348.5 c0,9.9-7.7,18-18.4,18s-18.4-8.1-18.4-18s7.7-18,18.4-18S-267.9-358.4-267.9-348.5'/>
                ...
                <div class='six columns'>
                    <h4 style='display:inline-block;font-weight:bolder;'>Engineer Statistics</h4>
                    </div>
                    <div class='six columns'>
                ...
                <div style='display: inline-block; margin-top: 10px; margin-right: 40px;'>
                    <input type='checkbox' name='sa' value='Shift A' style='margin-top: 5px;'><span style='padding:0 20px 0 7px;'>Shift A</span>
                    <input type='checkbox' name='sb' value='Shift B' style='margin-top: 5px;'><span style='padding:0 20px 0 7px;'>Shift B</span>
                    <input type='checkbox' name='sc' value='Shift C' style='margin-top: 5px;'><span style='padding:0 20px 0 7px;'>Shift C</span>
                    <input type='checkbox' name='sd'  value='Shift D' style='margin-top: 5px;'><span style='padding:0 20px 0 7px;'>Shift D</span>
                </div>   -->
                          ...
                          <!--   <div style='width: 28%;position:relative;display:inline-block;float:right;'>
                            ...
                            <div style='width: 20%;position:relative;display:inline-block;float:right;'>
                                <input id='chepura' name='s1' style='width: 210px;display:inline-block;float:right;margin-left:15px;padding: 8px;border:0; border-bottom: 1px solid #1EAEDB;margin-top:2px;' type='text' placeholder='Filter By Engineer CEC'/>
                                <!-- <button class='' type='submit' name='sub' value='&#x2794;' style='position:absolute;right:10px;padding:0;border:0;font-size:medium;bottom:4px;'>&#x2794;</button> -->
                            </div>
                    ...
                    <table id='maintable' class='u-full-width'>
                        <thead>
                            <tr>
                                ...
                                <th>Auto/ESR Cases</th>
                                <th>P1/P2 Cases</th>
                                <th>P3/P4 Cases</th>
                                <th style='white-space:nowrap;'>Time Available (mins)</th>
                                <th style='white-space:nowrap;'>Time in Except P1/P2 (mins)</th>
								<th style='white-space:nowrap;'>Time Unavailable (mins)</th>
