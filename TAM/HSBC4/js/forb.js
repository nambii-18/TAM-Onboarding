...
TweenMax.to(rcrp, .25, {ease:Linear.easeNone, delay: 2, repeat: -1, yoyo:true, attr: {transform: 'rotate(20, 186.3,231.38)'}});

TweenMax.to(headlight, 1, {repeat: -1, yoyo:true, attr: {fill: '#ff0000'}});
TweenMax.to(chestlight, 1, {repeat: -1, yoyo:true, attr: {fill: '#ff0000'}});

TweenMax.to(la, 1, {ease:Linear.easeNone, repeat: 0, repeatDelay:3, attr: {d: 'M169.35,172.71c20 0, 40 0, 80 0'}});

TweenMax.to(la, 1, {delay: 1, ease:Linear.easeNone, repeat: 0, repeatDelay:1, attr: {d: 'M169.35,172.71c0 0, 60 30, 55 -30'}});
