...
ob_start();
require("connect.php");
if(file_exists("C:/wamp64/tmp/new.csv")){
unlink("C:/wamp64/tmp/new.csv");
}

if(isset($_POST["report"])){
$sql="SELECT *
INTO OUTFILE 'C:/wamp64/tmp/new.csv'
...
if(mysqli_query($conn,$sql)){
 // echo "success";
  copy("C:/wamp64/tmp/new.csv","/var/www/html/report.csv");
}
else{
  echo $conn->error;
}
...
<html lang='en'>
    ...
    <head>
        ...
        <meta charset='utf-8'>
        <title>Reporting - CRT &middot; Cisco CMS</title>
...
<div class='row' style='margin-top:1%;'>
                <!-- <div class='eight columns
                    ...
                    <!-- <div class='four columns' style='float:right'>
                    	<a href='http://10.105.0.230:8080/download.csv' class='button' style='display: inline-block;float:right;margin-top: 3px;margin-bottom: 0;'>Export DB to *.CSV</a>
                    </div> -->

                    <div class='four columns'  style='text-align: left;'>
                    <h4 style='margin-bottom: 0;'>🌐&nbsp; GDCs</h4>
                    <div style='display:inline-block;'>
                    <span><a href='http://10.105.0.230:8080/gdc_trend_graph.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;'>📈&nbsp; Trending</a></span>

              <span><a href='http://10.105.0.230:8080/gdc-heatmap.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;margin-left:20px;'>↗&nbsp; Heat Map</a></span>
                    </div>
                    </div>
                    <div class='four columns'  style='text-align: center;'>
                    <h4 style='margin-bottom: 0;'>👨‍💻&nbsp; Engineers</h4>
                    <div style='display:inline-block;'>
                    <span><a href='http://10.105.0.230:8080/engineer_trend_graph.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;'>📈&nbsp; Trending</a></span>

              <span><a href='http://10.105.0.230:8080/eng-heatmap.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;margin-left:20px;'>↗&nbsp; Heat Map</a></span>
                    </div>
                    </div>
                    <div class='four columns'  style='text-align: right;'>
                    <h4 style='margin-bottom: 0;'>🏢&nbsp; Customers</h4>
                    <div style='display:inline-block;float:right;'>
                    <span><a href='http://10.105.0.230:8080/customer_trend_graph.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;'>📈&nbsp; Trending</a></span>

              <span><a href='http://10.105.0.230:8080/customer-heatmap.php' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;margin-left:20px;'>↗&nbsp; Heat Map</a></span>
                    </div>
                    </div>
