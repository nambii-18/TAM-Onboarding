...
<html lang='en'>
    ...
    <head>
        ...
        <meta charset='utf-8'>
        <title>Submit Review - CRT &middot; Cisco CMS</title>
    ...
    <div class='container u-max-full-width' style='z-index:99999;'>
        <div class='row' style='padding-top:15px;'>
          ...
          <div style='display:inline-block;float: right;'>
              ...
              <span><a href='http://cmstools.cisco.com:8000/en-us/app/cmstools_hsbc_voice/crt_overview' target='_blank' class='button' style='border: 0; border-bottom: 1px solid #212121;padding: 0;margin-left:20px;'>Reporting</a></span>
        ...
        <div class='container u-max-full-width'>
            <div class='row' style='margin-top:1%;'>
                <div class='twelve columns bg-this'>
                    <a href='case.php'><svg class='img-responsive logo' style='max-width: 185px;width:120px;' x='0px' y='0px' width='200.1px' height='105.4px' viewBox='-305 291.9 200.1 105.4'>
  <g class='logo__mark'>
...
<div class='row' style='margin-top: 1%;'>
<form id='caseform' method='POST' action='send.php' style='height:auto;margin-top:40px;'>
...
<!--Display this when case is closed-->
                        <!-- <div id='chepura' class='row u-max-full-width' style='display:none;'>
                        <h5 style='display: -webkit-inline-box;'><label class='switch' style='margin-bottom: 35px; margin-right: 25px; margin-top: 3px;'>

                          <input id='checkpaninga' type='checkbox'>
                          <div class='slider round'</div>

                        </label>
                        <span id='chesta'>This case is closed. Toggle to <span style='font-weight:normal'>reopen</span> this case.</span></h5>
                        ...
                        <label for='name'>Customer</label>
                            <input required='required' type='text' id='' name='customer' value='".$customer."''>
                        </div>
                        ...
                        <div class='field half tnb'>
                            ...
                            <input required='required' type='text' id='' name='towner' value='".$towner."'>
                            <!-- To be Autofilled for a user's session -->
                        </div>
                        <div class='field half tnb last'>
                            <label for='name'>Ticket Number</label>
                            <input required='required' type='text' id='' name='tnum' value=".$tnum.">
                            <!-- To be Autofilled for a user's session -->
                        </div>
                        <div class='field half tnb'>
                        <label for='name'>Ticket Create Date</label>
                            <input required='required' type='text' id='' name='createdate' value=".$createdate.">
                        </div>
                        <div class='field half tnb last'>
                            <label for='name'>Ticket Review Date</label>
                            <input required='required' type='text' id='' name='reviewdate' value=".date('Y-m-d').">
                            <!-- To be Autofilled for a user's session -->
                        </div>
                        <div class='field half tnb'>
                        <label for='name'>Global Delivery Center</label>
                            <input required='required' type='text' id='' name='gdc' value='".$gdc."''>

                        </div>
                        <div class='field half tnb last'>
                        <label for='name'>Ticket Priority</label>
                            <input required='required' type='text' id='' name='priority' value=".$priority.">
                            <input type='hidden' name='status' value='$status' />
                            <input type='hidden' name='mail' value='$mail' />

                        </div>

                        <a href='#review' class='button' style='margin-top:30px;color:#fff; background-color: #33C3F0;
    border-color: #33C3F0;'>Next &#x2193;</a>
...
";
    ...
    font-size: small;'>Resolution Summary Missing (-10)</label></td>
        ...
        <div class='field' style='margin-top:20px;'>
                    ...
                    <div style='display:inline-block;'>
                <input class='button-primary' type='submit' name='assign' value='Submit'>
...
//});
  ...
  if ($(this).is(':checked')) {
    $('#chesta').html('This case has been re-opened. Hit <span style=\'font-weight:normal\'>Submit</span> at the end of the review to close this case.');
  } else {
    $('#chesta').html('This case is closed. Toggle to <span style=\'font-weight:normal\'>reopen</span> this case.');
  }
});
        </script>
 </body>
